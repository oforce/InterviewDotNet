...
[TestSubject(typeof(Settlements))]
public class SettlementsTest(SettlementsTest.Context context)
    : IClassFixture<SettlementsTest.Context>
{
    [Fact]
    ...
    public void amounts_for_settlement_id(string settlementId, int expectedCount)
    {
        ...
        // Act
        var amounts = summaries.AmountsForSettlementId(Guid.Parse(settlementId));
    ...
    public void count_where_amounts_are_greater_than(int greaterThan, int expectedCount)
    {
        ...
        // Act
        var count = summaries.CountWhereAmountsAreGreaterThan(greaterThan);
    ...
    public void calculate_totals(string settlementId, decimal expectedGrossCommissions, decimal expectedGrossDeductions, decimal expectedNetTotal)
    {
        ...
        // Act
        var totals = summaries.CalculateTotals();
